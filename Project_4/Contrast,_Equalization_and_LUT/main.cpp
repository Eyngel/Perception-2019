...
int main(){
        ...
        Mat img = imread("/home/angel/Desktop/QT_Projects/Percepción/Project_4/rayosx.tif");
        ...
        const int RATIO = 30000 / IMG_HEIGHT ;
        ...
        for(int v = 0; v < 256; ++v)
        {
                ...
                cout<<pixel_values[v]<<" "; //muestra los valores máximos de cada pixel
